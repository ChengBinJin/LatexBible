...
\end{tikzpicture}
\end{center}
\hyperlinkframestart{\beamerbutton{frame start}}
\hyperlinkframeend{\beamerbutton{frame end}}
\hyperlinkframestartnext{\beamerbutton{frame start next}}
\hyperlinkframeendprev{\beamerbutton{frame end prev}}
\hyperlinkdocumentstart{\beamerbutton{document start}}
\hyperlinkdocumentend{\beamerbutton{document end}}
\end{frame}
...
\hyperlink{item:second}{\beamerbutton{Jump to the 2nd item}}
\hyperlink{item:second}{\beamergotobutton{Jump to the 2nd item}}
\hyperlink{item:second}{\beamerskipbutton{Jump to the 2nd item}}
\end{frame}
...
%Music playes
%\begin{itemize}
%\item \sound[inlinesound, repeat, label=Music1]{Can you hear the %Music?}{./multimedia/spacemusic.au}
%\item Auto Start \sound[inlinesound, autostart, loop, %label=Music2]{}{./multimedia/spacemusic.au}
%\item \sound[inlinesound, loop, channels=1, encoding=Signed, %samplingrage=22050, bitpersample=8, label=Music3]
%\item \sound[\inlinesound, loop, channels=1, encoding=ALaw, %samplingrate=22050, bitpersample=8, label=Music4]{뉴스알람2}{./%multimedia/newsalarm_ALaw.wav}
%\end{itemize}
%\end{frame}
...
%\movie[borderwidth=1pt, loop, showcontrols=true, label=Movie1, poster, width=100pt, height=80pt]{}{./multimedia/test.avi} &
%\movie[borderwidth=0pt, loop, start=0.5s, showcontrols=true, label=Movie2, width=3cm, height=2.4cm]{Test.avi}{./multimedia/test.avi} &
%\movie[borderwidth=0pt, loop, label=Movie3, externalviewer]{\underline{Play Movie}}{./multimedia/test.avi} \\ \hline
\end{tabular}
\end{center}

%\hyperlinkmovie[resume]{Movie1}{\beamerbutton{Resume Movie 1}}
%\hyperlinkmovie[stop]{Movie1}{\beamerbutton{Stop Movie 1}}
...
%\LaTeX Guide
%\end{center}
%\LaTeXe is powerful and easy to use. It supports slides class now.
%\end{slide}
