...
\texttt{minipage}는 \texttt{parbox}와 비슷하다. 반드시 폭을 주어야 한다.
\end{minipage}
\textbf{그러나} \
...
%\marginpar{\footnotesizes 오른쪽에 만들어진 가장자리 문단}

\marginpar{오른쪽에 만들어진 가장자리 문단}
...
%\newcommand{\hangl}{\lower -0.2em\hbox{{ㅎ\kern-.53em\lower .33em\hbox{$\cdot$}\kern -.7em\lower 1ex\hbox{ㄴ}}\lower 0.2em\hbox{글}}}
...
박스 앞뒤로 다른 문장이 이어져 나온다. 그 이유를 줄을 바꾸지 않았기 때문이다.}} \hfill 박스가 있다.
