...
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=0.9\textwidth] {../images/mari.png}};
...
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] (image) at (0,0) {\includegraphics[width=0.6\textwidth]{../images/mari.png}};
...
%\draw [thick, blue, path picture={\node at (path picture bounding box.center) {\includegraphics[width=6cm]{../images/mari.png}}}] (0,1) circle (1.5);
